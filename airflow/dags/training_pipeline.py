...
with DAG(
    ...
    from claims.pipeline.training import  TrainingPipeline
    from claims.pipeline.training import FinanceConfig
    training_pipeline= TrainingPipeline(FinanceConfig())

    def data_ingestion(**kwargs):
        from claims.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact,DataTransformationArtifact,\
